...
pub unsafe fn plot_quad_spline(
    ...
    assert!(n > 1_i32);
    x0 = 8_i32 * *x.offset(1_i32 as isize) - 2_i32 * *x.offset(0_i32 as isize);
    *x.offset(1_i32 as isize) = x0;
    y0 = 8_i32 * *y.offset(1_i32 as isize) - 2_i32 * *y.offset(0_i32 as isize);
    *y.offset(1_i32 as isize) = y0;
    ...
    while i < n {
        ...
        x0 = f64::floor(((8_i32 * *x.offset(i as isize)) as f32 - x0 as f32 * mi) as f64 + 0.5f64)
            as i32;
        *x.offset(i as isize) = x0;
        y0 = f64::floor(((8_i32 * *y.offset(i as isize)) as f32 - y0 as f32 * mi) as f64 + 0.5f64)
            as i32;
    ...
    plot_quad_bezier(
        *x.offset(0_i32 as isize),
        *y.offset(0_i32 as isize),
        x1,
        y1,
        x2,
        y2,
